--- 
title: 'Report: ZymoBIOMICS^®^ Shotgun Metagenomic Sequencing Service for Microbiome Analysis' 
...
name<-list.dirs(path = ".", recursive = FALSE, full.names=FALSE)
if (file.exists(paste0(dir(full.names=TRUE, pattern="^QC|^PositiveQC"), "/All/AbundanceTables/4.Species/abun_table.tsv")))
{
title<-'Controls'
...
'
data<-fread(paste0(dir(".",full.names=TRUE, pattern="^PositiveQC"),'/All/AbundanceTables/4.Species/abun_table.tsv'))
colnames(data)[1] <- "id"
...
if (file.exists(paste0(dir(full.names=TRUE, pattern="PositiveQC"), "/All/AbundanceTables/4.Species/abun_table.tsv")))
{
p
...
Microbial composition was profiled with Centrifuge (Kim et al., 2016) using bacterial, viral, fungal, mouse, and human genome datasets. 
Strain-level abundance information was extracted from the Centrifuge outputs and further analyzed: (1) to perform alpha- and beta-diversity analyses; 
...
(based on Bray-Curtis dissimilarity); and (4) for biomarker discovery with LEfSe (Segata et al., 2011) with default settings (p>0.05 and LDA effect size >2). Functional profiling was performed using Humann2 (Franzosa, et al., 2018) including identification of UniRef (Suzek et al., 2014) gene family and MetaCyc (Caspi et al., 2020) metabolic pathways. 
...
# References
`r paste0("Bolger, A.M., Lohse, M., and Usadel, B. (2014) Trimmomatic: a flexible trimmer for 
...
Franzosa E.A., McIver L.J., Rahnavard G., Thompson L.R., Schirmer M., Weingart G., Schwarzberg Lipson K., 
Knight R., Caporaso J.G., Segata N., Huttenhower C. (2018) 
Species-level functional profiling of metagenomes and metatranscriptomes. Nat Methods 15: 962-968. \n
